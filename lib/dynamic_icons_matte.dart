...
class DynamicIconsMatte extends StatelessWidget {
  ...
  final Map<String, IconData> iconList = {
    ...
    // 'six_ft_apart':Icons.six__ft_apart,size:sizes,
    // 'six_ft_apart_outlined':Icons.six_ft_apart_outlined,size:sizes,
    // 'six_ft_apart_rounded':Icons.six_ft_apart_rounded,size:sizes,
    // 'six_ft_apart_sharp':Icons.six_ft_apart_sharp,size:sizes,
    'six_k': Icons.six_k,
